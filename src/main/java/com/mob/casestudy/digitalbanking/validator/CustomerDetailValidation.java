...
public class CustomerDetailValidation {
    ...
    public void validateCustomerImageCaption(CustomerSecurityImageRequestBody customerSecurityImageRequestBody){
        ...
        if (isNullAndEmpty(securityImageId) || isNullAndEmpty(caption)){
    ...
    public boolean isNullAndEmpty(String value){
        return Objects.isNull(value) || value.isEmpty();
    }

    public boolean isEmailValid(String email) {
        return isNullAndEmpty(email) || email.matches(regexValues.getEmailRegex());
    }

    public boolean isPhoneValid(String number) {
        return isNullAndEmpty(number) || number.matches(regexValues.getPhoneRegex());
    }
